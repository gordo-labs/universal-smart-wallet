...
Read [AGENTS.md](AGENTS.md), inspect `git status --short --branch`, and work on
one task ID only. Do not silently combine tasks from different parallel lanes.

The project is not production-ready. Use synthetic credentials and local/testnet
chains only.
