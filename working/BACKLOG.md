...
| --- | --- | --- | --- | --- | --- |
| SSW-001 | Todo | P0 | foundation | Bootstrap the executable monorepo foundation | [task](tasks/SSW-001-monorepo-foundation.md) |
| SSW-002 | Todo | P0 | governance | Create the public GitHub repository and governance baseline | [task](tasks/SSW-002-public-repository-governance.md) |
